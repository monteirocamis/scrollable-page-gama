...
export declare abstract class MaterialLibraryBasePlugin extends AViewerPlugin<''> {
    ...
    protected _selectedObject: () => (IModel<any> & Mesh<BufferGeometry<import("three").NormalBufferAttributes, import("three").Event, string>, Material<import("three").Event, string>>) | undefined;
    protected _selectedMaterial: () => IMaterial<any> | undefined;
