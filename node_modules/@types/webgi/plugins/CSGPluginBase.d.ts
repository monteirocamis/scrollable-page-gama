...
export declare abstract class CSGPluginBase extends AViewerPlugin<''> {
    ...
    rootMesh: Mesh<import("three").BufferGeometry<import("three").NormalBufferAttributes, import("three").Event, string>, import("three").Material<import("three").Event, string> | import("three").Material<import("three").Event, string>[]>;
