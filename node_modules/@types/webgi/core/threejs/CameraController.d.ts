...
import { ICamera, IEventDispatcher, IOrthographicCameraOptions, IPerspectiveCameraOptions, IUiConfigContainer, UiObjectConfig } from 'webgi/interfaces';
...
export type TCameraControls = ICameraControls<'change' | string>;
