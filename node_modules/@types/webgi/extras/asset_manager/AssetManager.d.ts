import { AnyOptions, IDisposable, IEventDispatcher } from 'ts-browser-helpers';
import { IFile, IRenderTarget, ISceneObject, TAssetTypes } from 'webgi/interfaces';
...
export interface ILoader<T = any, T2 = any> {
...
export type ProcessImportedOptions = {
...
export type ImportFilesOptions = ProcessImportedOptions & ImportFileOptions & {
