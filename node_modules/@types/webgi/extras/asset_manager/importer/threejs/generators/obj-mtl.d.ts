...
export declare class ObjMtlLoadPlugin extends SimpleEventDispatcher<''> implements IViewerPlugin<ViewerApp> {
    static readonly PluginType = "ObjMtlLoadPlugin";
...
//# sourceMappingURL=obj-mtl.d.ts.map